...
import com.dvein.banking_backend.common.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Transaction endpoints (require CUSTOMER role)
                        .requestMatchers("/transactions/**", "/bills/**", "/merchant/**",
                        ...
                        .requestMatchers("/admin/transactions/**", "/admin/merchants/**",
